"""
LLM-based arbiter - сравнение с помощью языковой модели.
"""
...
class LLMArbiter(BaseArbiter):
    """
    LLM арбитр через OpenAI-совместимый API.
    
    Использует языковую модель для сравнения качества ответов.
    """
